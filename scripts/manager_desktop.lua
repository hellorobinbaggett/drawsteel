...
-- DEPRECATED - 2023-05-30 (Long Release)

function getSidebarDockCategoryIconColor()
	Debug.console("DesktopManager.getSidebarDockCategoryIconColor - DEPRECATED - 2023-05-30 - Use ColorManager.getSidebarCategoryIconColor");
	ChatManager.SystemMessage("DesktopManager.getSidebarDockCategoryIconColor - DEPRECATED - 2023-05-30 - Contact ruleset/extension/forge author");
	return ColorManager.getSidebarCategoryIconColor();
end
function getSidebarDockCategoryTextColor()
	Debug.console("DesktopManager.getSidebarDockCategoryTextColor - DEPRECATED - 2023-05-30 - Use ColorManager.getSidebarCategoryTextColor");
	ChatManager.SystemMessage("DesktopManager.getSidebarDockCategoryTextColor - DEPRECATED - 2023-05-30 - Contact ruleset/extension/forge author");
	return ColorManager.getSidebarCategoryTextColor();
end
function getSidebarDockIconColor()
	Debug.console("DesktopManager.getSidebarDockIconColor - DEPRECATED - 2023-05-30 - Use ColorManager.getSidebarRecordIconColor");
	ChatManager.SystemMessage("DesktopManager.getSidebarDockIconColor - DEPRECATED - 2023-05-30 - Contact ruleset/extension/forge author");
	return ColorManager.getSidebarRecordIconColor();
end
function getSidebarDockTextColor()
	Debug.console("DesktopManager.getSidebarDockTextColor - DEPRECATED - 2023-05-30 - Use ColorManager.getSidebarRecordTextColor");
	ChatManager.SystemMessage("DesktopManager.getSidebarDockTextColor - DEPRECATED - 2023-05-30 - Contact ruleset/extension/forge author");
	return ColorManager.getSidebarRecordTextColor();
end
function setSidebarDockCategoryIconColor(s)
	Debug.console("DesktopManager.setSidebarDockCategoryIconColor - DEPRECATED - 2023-05-30 - Use ColorManager.setSidebarCategoryIconColor");
	ChatManager.SystemMessage("DesktopManager.setSidebarDockCategoryIconColor - DEPRECATED - 2023-05-30 - Contact ruleset/extension/forge author");
	ColorManager.setSidebarCategoryIconColor(s);
end
function setSidebarDockCategoryTextColor(s)
	Debug.console("DesktopManager.setSidebarDockCategoryTextColor - DEPRECATED - 2023-05-30 - Use ColorManager.setSidebarCategoryTextColor");
	ChatManager.SystemMessage("DesktopManager.setSidebarDockCategoryTextColor - DEPRECATED - 2023-05-30 - Contact ruleset/extension/forge author");
	ColorManager.setSidebarCategoryTextColor(s);
end
function setSidebarDockIconColor(s)
	Debug.console("DesktopManager.setSidebarDockIconColor - DEPRECATED - 2023-05-30 - Use ColorManager.setSidebarRecordIconColor");
	ChatManager.SystemMessage("DesktopManager.setSidebarDockIconColor - DEPRECATED - 2023-05-30 - Contact ruleset/extension/forge author");
	ColorManager.setSidebarRecordIconColor(s);
end
function setSidebarDockTextColor(s)
	Debug.console("DesktopManager.setSidebarDockTextColor - DEPRECATED - 2023-05-30 - Use ColorManager.setSidebarRecordTextColor");
	ChatManager.SystemMessage("DesktopManager.setSidebarDockTextColor - DEPRECATED - 2023-05-30 - Contact ruleset/extension/forge author");
	ColorManager.setSidebarRecordTextColor(s);
end
