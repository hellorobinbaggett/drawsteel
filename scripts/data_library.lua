...
aRecords = {
	...
	["ancestry"] = {
		...
		-- sListDisplayClass = "masterindexitem_story",
		-- fRecordDisplayClass = getStoryDisplayClass,
		aRecordDisplayClasses = { "referenceancestry", },
		aGMEditButtons = { "button_ancestry_add_advanced", },
		aExportAuxSource = { "reference.ancestryindex", },
		aExportAuxTarget = { "reference.ancestryindex", }, 
		bExport = true,
	},
	["class"] = {
		nExport = 2,
		...
		-- sListDisplayClass = "masterindexitem_story",
		-- fRecordDisplayClass = getStoryDisplayClass,
		aRecordDisplayClasses = { "referenceclass", },
		aGMEditButtons = { "button_class_add_advanced", },
		aExportAuxSource = { "reference.classindex", },
		aExportAuxTarget = { "reference.classindex", }, 
		bExport = true,
	},
	["ability"] = { 
		bExport = true,
